...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Rpicoin Core rpicoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  rpicoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rpicoin transaction") + "\n" +
                               "  rpicoin-tx [options] -create [commands]   " + _("Create hex-encoded rpicoin transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded rpicoin transaction
