...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            RPICOINGUI* window = static_cast<RPICOINGUI*>(parentWidget());
...
{
    RPICOINGUI* gui = static_cast<RPICOINGUI*>(parentWidget());
...
{
    hide();
    static_cast<RPICOINGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
