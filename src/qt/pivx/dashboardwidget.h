...
#include "config/rpicoin-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalRpi = 0;
    qint64 totalZrpi = 0;
    QList<qreal> valuesRpi;
    QList<qreal> valueszRpi;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(RPICOINGUI* _window);
    ~DashboardWidget();
