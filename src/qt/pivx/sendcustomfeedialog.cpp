...
#include "qt/rpicoin/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(RPICOINGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &RPICOINGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
