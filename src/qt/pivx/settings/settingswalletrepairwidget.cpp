...
#include "qt/rpicoin/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/rpicoin/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(RPICOINGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to RPICOINGUI::handleRestart()
