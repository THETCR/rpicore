...
#include "qt/rpicoin/settings/forms/ui_settingsconsolewidget.h"
...
#include "qt/rpicoin/settings/moc_settingsconsolewidget.cpp"
...
SettingsConsoleWidget::SettingsConsoleWidget(RPICOINGUI* _window, QWidget *parent) :
...
void SettingsConsoleWidget::clear(bool clearHistory)
{
    ...
    message(CMD_REPLY, (tr("Welcome to the RPICOIN RPC console.") + "<br>" +
