...
#include "qt/rpicoin/settings/forms/ui_settingsfaqwidget.h"
#include <QScrollBar>
#include <QMetaObject>
#include "qt/rpicoin/qtutils.h"

SettingsFaqWidget::SettingsFaqWidget(RPICOINGUI *parent) :
    QDialog(parent),
    ui(new Ui::SettingsFaqWidget)
{
    ...
    setCssProperty({
              ...
              ui->labelSubtitle_UnspendableRPI,
    ...
    setCssProperty({
              ...
              ui->labelContent_UnspendableRPI,
    ...
    connect(ui->pushButton_UnspendableRPI, &QPushButton::clicked, [this](){onFaqClicked(ui->widget_UnspendableRPI);});
    ...
    if (parent)
        connect(parent, &RPICOINGUI::windowResizeEvent, this, &SettingsFaqWidget::windowResizeEvent);
}
