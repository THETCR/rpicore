...
#include "qt/rpicoin/settings/forms/ui_settingswidget.h"
...
SettingsWidget::SettingsWidget(RPICOINGUI* parent) :
    PWidget(parent),
    ui(new Ui::SettingsWidget)
{
    ...
    connect(ui->pushButtonHelp1, &QPushButton::clicked, window, &RPICOINGUI::openFAQ);
