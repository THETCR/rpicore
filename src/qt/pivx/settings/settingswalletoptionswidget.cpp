...
#include "qt/rpicoin/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/rpicoin/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(RPICOINGUI* _window, QWidget *parent) :
