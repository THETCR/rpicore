...
#ifndef RPICOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
#define RPICOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
...
#endif //RPICOIN_CORE_NEW_GUI_ADDRESSFILTERPROXYMODEL_H
