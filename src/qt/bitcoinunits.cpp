...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(RPI);
    unitlist.append(mRPI);
    unitlist.append(uRPI);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case RPI:
        return QString("rpicoin");
    case mRPI:
        return QString("mrpicoin");
    case uRPI:
        return QString::fromUtf8("urpicoin");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZrpi)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZRPI)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZRPI);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZRPI)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZRPI));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
