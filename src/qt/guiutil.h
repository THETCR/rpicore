...
/** Utility functions used by the RPICOIN Qt UI.
 */
namespace GUIUtil
{
...
// Render RPICOIN addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZrpi = false);
