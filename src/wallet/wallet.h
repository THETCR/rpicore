...
enum WalletFeature {
    ...
    FEATURE_PRE_RPICOIN = 61000, // inherited version..
...
enum ZerocoinSpendStatus {
    ...
    ZRPI_TXMINT_GENERAL = 9,                        // General errors in MintsToInputVectorPublicSpend
...
public:
    ...
    /// Get 10000 RPI output and keys which can be used for the Masternode
    ...
    void doZRpiRescan(const CBlockIndex* pindex, const CBlock& block, std::set<uint256>& setAddedToWallet, const Consensus::Params& consensus, bool fCheckZRPI);
    ...
    // zRPI wallet
    std::unique_ptr<CzRPITracker> zrpiTracker{nullptr};
    void setZWallet(CzRPIWallet* zwallet);
    CzRPIWallet* getZWallet();
