...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        # Extend the b26 chain to make sure rpicoind isn't accepting b26
        ...
        # Extend the b28 chain to make sure rpicoind isn't accepting b28
