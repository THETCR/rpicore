...
The script [extract-osx-sdk.sh](https://github.com/rpicoin-project/rpicoin/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
rpicoin/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/rpicoin-project/rpicoin/blob/master/doc/README_osx.md) for troubleshooting tips.