...
The build script we'll be using is contained in the RPICOIN github repository ([contrib/gitian-build.py](https://github.com/rpicoin-project/rpicoin/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the RPICOIN repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/RPICOIN-Project/RPICOIN/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, rpicoin-detached-sigs, and rpicoin GitHub repos.
